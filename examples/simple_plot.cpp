  ...
  while (!canvas.shouldClose()) {
    ...
    if (show_plot) {
      canvas.show_window(
          "Plot",
          [&data_map] {
            ImGui::PlotLines("position", data_map.data("position"),
                             data_map.len("position"), 0, NULL, -1, 1,
                             ImVec2(0, 80));

            ImGui::PlotLines("velocity", data_map.data("velocity"),
                             data_map.len("velocity"), 0, NULL, -1, 1,
                             ImVec2(0, 80));

            ImGui::PlotLines("acceleration", data_map.data("acceleration"),
                             data_map.len("acceleration"), 0, NULL, -1, 1,
                             ImVec2(0, 80));
          },
